...
import com.io.securityInfrun.util.AjaxAuthentivationToken;

@Service("ajaxAuthenticationProvider")
public class AjaxAuthenticationProvider implements AuthenticationProvider{
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		//이제 토큰만들어주기
		AjaxAuthentivationToken authenticationToken = new AjaxAuthentivationToken(userDetails, null, userDetails.getAuthorities());
	...
	public boolean supports(Class<?> authentication) {
		...
		return AjaxAuthentivationToken.class.isAssignableFrom(authentication);
	}
